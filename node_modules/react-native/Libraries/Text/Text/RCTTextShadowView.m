...
#else
  // JM:XXX
  NSAttributedString *attributedString = [shadowTextView attributedTextWithMeasuredAttachmentsThatFitSize:maximumSize];
  CGRect boundingRect = [attributedString boundingRectWithSize:maximumSize
