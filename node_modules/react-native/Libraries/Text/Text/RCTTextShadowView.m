...
//    }];
    ...
    CGRect contentFrame = CGRectMake(0, 0, 400, 20);

    // Removing all references to Shadow Views to avoid unnececery retainning.
//    NSTextStorage *textStorage = [self textStorageAndLayoutManagerThatFitsSize:contentFrame.size
//                                                            exclusiveOwnership:YES];

    NSAttributedString *attributedString = [self attributedTextWithBaseTextAttributes:nil];
...
#else
  return [self attributedTextWithBaseTextAttributes:nil];
#endif
}
...
#else
  return (YGSize){
    RCTYogaFloatFromCoreGraphicsFloat(400),
    RCTYogaFloatFromCoreGraphicsFloat(20)
  };
#endif
}
...
#else
  return RCTYogaFloatFromCoreGraphicsFloat(20);
#endif
}
