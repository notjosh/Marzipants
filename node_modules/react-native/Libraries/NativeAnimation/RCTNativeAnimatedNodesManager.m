...
#else
    // lol. 10.14 has CADisplayLink somewhere, just need a header for it. doh.
    _displayLink = [NSTimer scheduledTimerWithTimeInterval:1/60 target:self selector:@selector(stepAnimations:) userInfo:nil repeats:YES];
...
#else
  [NSDate date].timeIntervalSince1970 - _timestamp;
#endif
